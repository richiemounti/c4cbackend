...
exports.STAKEHOLDER_TASKS = exports.STAKEHOLDER_BENEFITS = exports.STAKEHOLDER_RISKS = exports.STAKEHOLDER_ROLES = exports.STAKEHOLDER_WELLBEING = exports.STAKEHOLDER_POWER = exports.STAKEHOLDER_CONNECTIONS = exports.STAKEHOLDER_CATEGORIES = void 0;
exports.getOptionsForTaskAndCategory = getOptionsForTaskAndCategory;
exports.getOptionLabel = getOptionLabel;
exports.getAllLabelsForTaskAndCategory = getAllLabelsForTaskAndCategory;
...
exports.STAKEHOLDER_CONNECTIONS = {
    'National Government': [
        {
            id: 'policy_oversight',
...
function getOptionsForTaskAndCategory(taskType, category) {
    switch (taskType) {
        case 'connections':
            return exports.STAKEHOLDER_CONNECTIONS[category] || [];
        case 'power':
            return exports.STAKEHOLDER_POWER[category] || [];
        case 'wellbeing':
            return exports.STAKEHOLDER_WELLBEING[category] || [];
        case 'roles':
            return exports.STAKEHOLDER_ROLES[category] || [];
        case 'risks':
            return exports.STAKEHOLDER_RISKS[category] || [];
        case 'benefits':
            return exports.STAKEHOLDER_BENEFITS[category] || [];
        default:
            return [];
    }
}
// Helper function to get the label for a connection type
function getOptionLabel(taskType, category, optionId) {
...
function getAllLabelsForTaskAndCategory(taskType, category) {
    const options = getOptionsForTaskAndCategory(taskType, category);
    return options.map(o => o.label);
}
//# sourceMappingURL=stakeholder.constants.js.map