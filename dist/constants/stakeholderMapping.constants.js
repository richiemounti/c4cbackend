...
exports.getTaskPrompt = exports.getOptionsForTaskAndCategory = exports.CATEGORY_OPTIONS_MAP = exports.RESOURCE_MANAGER_OPTIONS = exports.OUR_ORGANISATION_OPTIONS = exports.PARTNER_OPTIONS = exports.WOMEN_YOUTH_VULNERABLE_OPTIONS = exports.COMMUNITIES_OPTIONS = exports.LOCAL_GOVERNMENT_OPTIONS = exports.NATIONAL_GOVERNMENT_OPTIONS = exports.TASK_PROMPTS = exports.TASK_TYPE_LABELS = exports.TASK_TYPES = exports.STAKEHOLDER_CATEGORIES = void 0;
// Define the standard category names
exports.STAKEHOLDER_CATEGORIES = [
    'National Government',
    'Local Government',
...
exports.NATIONAL_GOVERNMENT_OPTIONS = {
    'connections': [
...
exports.LOCAL_GOVERNMENT_OPTIONS = {
    'connections': [
...
exports.WOMEN_YOUTH_VULNERABLE_OPTIONS = {
    'connections': [
...
exports.RESOURCE_MANAGER_OPTIONS = {
    'connections': [
...
exports.CATEGORY_OPTIONS_MAP = {
    'National Government': exports.NATIONAL_GOVERNMENT_OPTIONS,
    'Local Government': exports.LOCAL_GOVERNMENT_OPTIONS,
    'Communities Affected by the Project': exports.COMMUNITIES_OPTIONS,
    'Women, Youth, and Vulnerable Groups': exports.WOMEN_YOUTH_VULNERABLE_OPTIONS,
    'Partner Agencies': exports.PARTNER_OPTIONS,
    'Our Organisation': exports.OUR_ORGANISATION_OPTIONS,
    'Resource Manager': exports.RESOURCE_MANAGER_OPTIONS
};
// Function to get task options for a specific category and task type
const getOptionsForTaskAndCategory = (taskType, categoryName) => {
    if (!exports.CATEGORY_OPTIONS_MAP[categoryName]) {
        return [];
    }
    if (!exports.CATEGORY_OPTIONS_MAP[categoryName][taskType]) {
        return [];
    }
    return exports.CATEGORY_OPTIONS_MAP[categoryName][taskType];
};
exports.getOptionsForTaskAndCategory = getOptionsForTaskAndCategory;
// Function to get the task prompt for a specific task type
const getTaskPrompt = (taskType) => {
    return exports.TASK_PROMPTS[taskType] || null;
};
exports.getTaskPrompt = getTaskPrompt;
//# sourceMappingURL=stakeholderMapping.constants.js.map