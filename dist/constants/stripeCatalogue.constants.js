...
exports.STRIPE_CATALOGUE = void 0;
const TIER_RANGES = {
    tier_1: '1 project',
    tier_2: '2-3 projects',
    tier_3: '4-5 projects',
};
exports.STRIPE_CATALOGUE = [
    {
        key: 'om_self_serve',
        name: 'Outcome Mapping & Monitoring — Self-Serve',
        description: 'Core bundle: Stakeholder mapping, ToC design, Survey build & data collection, Data visualisation.',
        isCoreBundle: true,
    ...
    },
    {
        ...
        description: 'Core bundle plus account management and mentoring (~25% of Hannah\'s time). Learning infrastructure with human support, not just platform access.',
        isCoreBundle: true,
    ...
    },
    {
        ...
        description: 'Add-on to the Self-Serve core bundle. Moves from monitoring to learning - understanding what is working, why, and what to do differently.',
        isCoreBundle: false,
        bundleTrack: 'self_serve',
        tiers: [
    ...
    },
    {
        ...
        description: 'Add-on to the Self-Serve core bundle. Maps stakeholder relationships and influence networks across project communities.',
        isCoreBundle: false,
        bundleTrack: 'self_serve',
        tiers: [
    ...
    },
    {
        ...
        description: 'Add-on to the Supported core bundle. Includes facilitated stakeholder mapping workshops and analysis.',
        isCoreBundle: false,
        bundleTrack: 'supported',
        tiers: [
    ...
    },
    {
        key: 'sroi_analysis',
        name: 'SROI Analysis',
        description: 'One-off Social Return on Investment analysis and report. Available as an add-on to both Self-Serve and Supported bundles. Flat fee across all tiers.',
        isCoreBundle: false,
        bundleTrack: 'any',
        tiers: [
...
//# sourceMappingURL=stripeCatalogue.constants.js.map