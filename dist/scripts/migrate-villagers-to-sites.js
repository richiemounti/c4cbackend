...
exports.migrateVillagersToSites = void 0;
...
const projectSiteSchema = new mongoose_1.default.Schema({}, { strict: false });
const StakeholderGroup = mongoose_1.default.model('StakeholderGroup', stakeholderGroupSchema);
const ProjectSite = mongoose_1.default.model('ProjectSite', projectSiteSchema);
 ...
 */
const validateMigrationData = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    for (const mapping of MIGRATION_MAP) {
        ...
        const stakeholder = yield StakeholderGroup.findById(mapping.stakeholderId);
        if (!stakeholder) {
        ...
        // Check site exists
        const site = yield ProjectSite.findById(mapping.siteId);
        if (!site) {
        ...
        const existingAtSite = yield StakeholderGroup.findOne({
        ...
        console.log(`      - Tasks: ${((_a = stakeholder.tasks) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
        console.log(`      - Status: ${stakeholder.completionStatus}`);
        console.log(`      - Themes: ${((_b = stakeholder.themes) === null || _b === void 0 ? void 0 : _b.length) || 0}`);
 ...
 */
const migrateVillagersToSites = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        const isValid = yield validateMigrationData();
        if (!isValid) {
        ...
        for (const mapping of MIGRATION_MAP) {
            try {
                ...
                const result = yield StakeholderGroup.updateOne({ _id: mapping.stakeholderId }, {
                    $set: {
                        projectSite: new mongoose_1.default.Types.ObjectId(mapping.siteId),
                        updatedAt: new Date()
                    }
                });
                if (result.modifiedCount === 1) {
                    ...
                    successCount++;
                    // Verify the update
                    const updated = yield StakeholderGroup.findById(mapping.stakeholderId);
                    if (updated && updated.projectSite) {
                        console.log(`   ✓ Verified: projectSite = ${updated.projectSite}`);
                        console.log(`   ✓ All data preserved (${((_a = updated.tasks) === null || _a === void 0 ? void 0 : _a.length) || 0} tasks, ${((_b = updated.themes) === null || _b === void 0 ? void 0 : _b.length) || 0} themes)\n`);
                    }
                }
                else {
...
exports.migrateVillagersToSites = migrateVillagersToSites;
// Run the migration
const runMigration = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield migrateVillagersToSites();
...
//# sourceMappingURL=migrate-villagers-to-sites.js.map