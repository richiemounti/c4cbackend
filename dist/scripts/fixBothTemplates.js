...
function fixBothTemplates() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const projectTemplate = yield TaskTemplateCollection.findOne({
                type: 'project',
                isActive: true
            });
            if (!projectTemplate) {
            ...
            for (const update of projectUpdates) {
                const taskIndex = projectTemplate.tasks.findIndex((t) => t.fieldName === update.fieldName);
                if (taskIndex !== -1) {
            ...
            yield TaskTemplateCollection.updateOne({ _id: projectTemplate._id }, { $set: { tasks: projectTemplate.tasks, updatedAt: projectTemplate.updatedAt } });
            ...
            const siteTemplate = yield TaskTemplateCollection.findOne({
                type: 'projectSite',
                isActive: true
            });
            if (!siteTemplate) {
            ...
            for (const update of siteUpdates) {
                const taskIndex = siteTemplate.tasks.findIndex((t) => t.fieldName === update.fieldName);
                if (taskIndex !== -1) {
                    console.log(`  ✓ Updating ${update.fieldName}...`);
            ...
            yield TaskTemplateCollection.updateOne({ _id: siteTemplate._id }, { $set: { tasks: siteTemplate.tasks, updatedAt: siteTemplate.updatedAt } });
...
//# sourceMappingURL=fixBothTemplates.js.map