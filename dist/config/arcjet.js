...
function initArcjet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const arcjetModule = yield Promise.resolve().then(() => __importStar(require('@arcjet/node')));
        ...
        const keyPrefix = (_a = env_1.env.ARCJET_KEY) === null || _a === void 0 ? void 0 : _a.substring(0, 4);
        console.log(`Using Arcjet key starting with: ${keyPrefix}...`);
        try {
            const aj = arcjet({
                key: env_1.env.ARCJET_KEY,
