...
exports.generateSimpleReportTitle = exports.generateReportTitle = void 0;
/**
 ...
 */
const generateReportTitle = (reportType, options) => {
...
exports.generateReportTitle = generateReportTitle;
/**
 * Legacy function for backward compatibility
 * @deprecated Use generateReportTitle with options object instead
 */
const generateSimpleReportTitle = (reportType, entityName, date = new Date()) => {
    const reportTypeNames = {
        'project_setup': 'Project Setup Report',
        'project_site_setup': 'Project Site Setup Report',
        'stakeholder_mapping': 'Stakeholder Mapping Report',
...
exports.generateSimpleReportTitle = generateSimpleReportTitle;
//# sourceMappingURL=reportTitleGenerator.js.map