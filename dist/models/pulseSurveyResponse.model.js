...
const pulseSurveyResponseSchema = new mongoose_1.default.Schema({
...
pulseSurveyResponseSchema.pre('save', function (next) {
    ...
    const ratingResponses = this.responses.filter(r => r.questionType === 'rating' && r.ratingValue !== undefined);
...
const PulseSurveyResponse = mongoose_1.default.model('PulseSurveyResponse', pulseSurveyResponseSchema);
exports.default = PulseSurveyResponse;
//# sourceMappingURL=pulseSurveyResponse.model.js.map