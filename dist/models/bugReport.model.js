...
const sourceOfFeedbackSchema = new mongoose_1.default.Schema({
    source: {
        type: String,
        required: true,
        trim: true,
...
const systemInfoSchema = new mongoose_1.default.Schema({
...
const userExperienceRatingSchema = new mongoose_1.default.Schema({
    overallSatisfaction: {
        type: Number,
        min: 1,
        max: 5,
...
const featureSuggestionSchema = new mongoose_1.default.Schema({
    description: {
        type: String,
        required: true,
        trim: true,
...
const bugReportSchema = new mongoose_1.default.Schema({
...
bugReportSchema.virtual('overallScore').get(function () {
    ...
    score += priorityScores[this.priority] || 40;
    // Business impact scoring
    if ((_a = this.businessImpact) === null || _a === void 0 ? void 0 : _a.functionalityBlocked)
        score += 30;
    if ((_b = this.businessImpact) === null || _b === void 0 ? void 0 : _b.revenueImpact)
        score += 25;
    if ((_c = this.businessImpact) === null || _c === void 0 ? void 0 : _c.complianceImpact)
        score += 35;
    // Affected users multiplier
    const userImpactScores = { 'all': 50, 'most': 40, 'many': 30, 'some': 20, 'few': 10 };
    score += userImpactScores[(_d = this.businessImpact) === null || _d === void 0 ? void 0 : _d.affectedUsers] || 10;
    return Math.min(score, 255); // Cap at 255 for database efficiency
});
// Method to update metrics
bugReportSchema.methods.updateMetrics = function () {
...
//# sourceMappingURL=bugReport.model.js.map