...
const stakeholderTaskOptionSchema = new mongoose_1.default.Schema({
...
stakeholderTaskOptionSchema.index({ category: 1, taskType: 1, optionId: 1 }, { unique: true });
const StakeholderTaskOption = mongoose_1.default.model('StakeholderTaskOption', stakeholderTaskOptionSchema);
exports.default = StakeholderTaskOption;
//# sourceMappingURL=stakeholderTaskOption.model.js.map