...
const projectSetupTaskSchema = new mongoose_1.default.Schema({
    fieldName: {
        type: String,
        required: true,
        trim: true
...
const projectSetupSchema = new mongoose_1.default.Schema({
    project: {
        type: mongoose_1.default.Schema.Types.ObjectId,
        ref: 'Project',
        required: true,
...
projectSetupSchema.methods.calculateProgress = function () {
...
const ProjectSetup = mongoose_1.default.model('ProjectSetup', projectSetupSchema);
exports.default = ProjectSetup;
//# sourceMappingURL=projectSetupTask.model.js.map