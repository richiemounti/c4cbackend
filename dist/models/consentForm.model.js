...
const consentFormSchema = new mongoose_1.default.Schema({
    name: {
        type: String,
...
consentFormSchema.methods.recordUsage = function () {
...
consentFormSchema.statics.getActiveForProject = function (projectId, organizationId) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = {
            isActive: true,
            archived: { $ne: true },
...
const ConsentForm = mongoose_1.default.model('ConsentForm', consentFormSchema);
exports.default = ConsentForm;
//# sourceMappingURL=consentForm.model.js.map